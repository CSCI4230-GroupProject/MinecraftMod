...
{	
       public ItemWoodArmor(ArmorMaterial material, int ArmorType, String name) 
	{
	...
	{
		if (stack.getItem() == ModItems.woodHelm || stack.getItem() == ModItems.woodPlate || stack.getItem() == ModItems.woodBoots)
		{
			return Reference.MODID + ":textures/armor/titanium_layer1.png";
		}
		else if (stack.getItem() == ModItems.woodPants)
		{
